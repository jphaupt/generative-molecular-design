...
def test_rot_trans_invariance(single_batch, random_orthogonal_matrix, device):
    ...
    with torch.no_grad():
        ...
        node_features1, distances1, directions1, edge_features1, mu1, log_var1, property_pred1 = outputs1
    ...
    with torch.no_grad():
        ...
        node_features2, distances2, directions2, edge_features2, mu2, log_var2, property_pred2 = outputs2
